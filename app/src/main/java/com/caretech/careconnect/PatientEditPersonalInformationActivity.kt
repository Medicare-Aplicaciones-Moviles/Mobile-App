    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnActualizar.setOnClickListener {
            ...
            val patient = PatientRequestInEditInformation(
                ...
                fechaNacimiento = etDate?.text.toString(),
                telefono = etTelefono?.text.toString(),
                altura = etAltura.text.toString().toFloatOrNull() ?: 0f,
                peso = etPeso.text.toString().toFloatOrNull() ?: 0f,
                masaCorporal = etMasa.text.toString().toFloatOrNull() ?: 0f,
                foto = foto ?: ""
            )
            ...
            requestUpdate.enqueue(object : Callback<Patient> {
                override fun onResponse(call: Call<Patient>, response: Response<Patient>) {
                    if (response.isSuccessful) {
                        ...
                        etNombre.setText(patient.nombre)
                        etApellido.setText(patient.apellido)
                        etDate.setText(patient.fechaDeNacimiento.toString())
                        etTelefono.setText(patient.telefono)
                        etAltura.setText(patient.altura.toString())
                        etPeso.setText(patient.peso.toString())
                        etMasa.setText(patient.masaCorporal.toString())
